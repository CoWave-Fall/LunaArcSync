...
import 'package:luna_arc_sync/presentation/pages/view/page_swipe_view.dart';
...
// PagesListView 现在是一个更简单的容器，只负责提供 Bloc
class PagesListView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      // Scaffold 现在由 PagesListViewWidget 自己管理
      child: const PagesListViewWidget(),
    );
  }
}

// PagesListViewWidget 包含了所有的 UI 和交互逻辑
class PagesListViewWidget extends StatefulWidget {
  const PagesListViewWidget({super.key});

  @override
  State<PagesListViewWidget> createState() => _PagesListViewWidgetState();
}

class _PagesListViewWidgetState extends State<PagesListViewWidget> {
    ...
    return Scaffold(
      body: BlocConsumer<PageListCubit, PageListState>(
        listener: (context, state) {
          if (state.status == PageListStatus.success &&
